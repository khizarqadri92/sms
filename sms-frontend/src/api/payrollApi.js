...
const payrollApi = {
  ...
  getStaffBankInfo:    (staffId)     => client.get(`/payroll/staff/${staffId}/bank-info`),
  downloadPayrollRun:  (runId)       => client.get(`/payroll/runs/${runId}/download`, {responseType:"blob"}),
  downloadSalarySlip:  (runId, staffId) => client.get(`/payroll/runs/${runId}/payslip/${staffId}`, {responseType:"blob"}),
  sendPayslips:        (runId)       => client.post(`/payroll/runs/${runId}/send-payslips`),
  getMyPayslips:       ()            => client.get(`/payroll/my-payslips`),
  updateStaffBankInfo: (staffId, data) => client.put(`/payroll/staff/${staffId}/bank-info`, data),
  ...
  markAdjustmentsDone: (runId)     => client.post(`/payroll/runs/${runId}/mark-adjustments-done`),
